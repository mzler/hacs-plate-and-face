...
# Configuration keys
# ---------------------------------------------------------------------------
CONF_ADDON_URL = "addon_url"          # NEW: Add-on REST API base URL
...
# Defaults
# ---------------------------------------------------------------------------
DEFAULT_ADDON_URL = "http://localhost:8585"  # Add-on default port
...
# Known-faces sensor data key (stored in coordinator.data)
DATA_KEY_KNOWN_FACES = "_known_faces"
...
# ---------------------------------------------------------------------------
# Plate regex patterns (kept for reference / future use)
# ---------------------------------------------------------------------------
PLATE_PATTERNS = [
